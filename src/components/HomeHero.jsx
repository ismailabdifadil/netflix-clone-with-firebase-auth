...
const HomeHero = () => {
  return (
    ...
    >
      ...
      <main className="flex flex-1 flex-col items-center justify-center text-center sm:px-20 container">
        <h1 className="max-w-2xl sm:max-w-2xl text-5xl sm:text-5xl font-bold tracking-wide text-white">
          Unlimited movies, TV Shows, and more.
        </h1>
        <h2 className="mt-4 mb-8 text-xl text-white">
