...
const Header = () => {
  ...
  return (
    <div
      ...
      } px-6 py-4 flex justify-between  fixed w-full z-10 transition-all`}
    >
      ...
      <div className="flex space-x-3 items-center *:cursor-pointer">
        <MdNotifications size={25} className="hover:text-[#898989]" />
        <MdSearch size={25} className="hover:text-[#898989]" />
        <img
